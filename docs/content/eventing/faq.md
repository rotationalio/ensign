...
Who has permission to connect to the database? In Ensign, you create a `workspace` to grant roles and adjust permissions for each teammate. You can have an workspace of one, but it's not as fun 😉
