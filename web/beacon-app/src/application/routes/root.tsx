...
import ExistingUserInvitePage from '@/features/teams/components/ExistingUserInvitePage';
import NewUserInvitePage from '@/features/teams/components/NewUserInvitePage';
  ...
  createRoutesFromElements(
    <Route element={<Root />} errorElement={<ErrorPage />}>
      ...
      <Route element={<PublicRoutes />}>
        ...
        <Route path="existing-invitation" element={<ExistingUserInvitePage />} />
        <Route path="new-invitation" element={<NewUserInvitePage />} />
      </Route>
