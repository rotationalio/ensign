...
const PrivateRoute = () => {
  ...
  const isOnboarded = isOnboardedMember(member?.onboarding_status); // TODO: changes status -> onbording_status once api is updated
  // if the user is not onboarded, set the current step
