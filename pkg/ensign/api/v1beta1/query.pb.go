...
var file_api_v1beta1_query_proto_goTypes = []any{
...
func file_api_v1beta1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1beta1_query_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1beta1_query_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_v1beta1_query_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_api_v1beta1_query_proto_msgTypes[1].OneofWrappers = []any{
		(*Parameter_I)(nil),
		(*Parameter_D)(nil),
		(*Parameter_B)(nil),
		(*Parameter_Y)(nil),
