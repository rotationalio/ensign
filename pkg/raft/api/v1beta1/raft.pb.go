...
var file_raft_v1beta1_raft_proto_goTypes = []any{
...
func file_raft_v1beta1_raft_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_raft_v1beta1_raft_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_raft_v1beta1_raft_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_raft_v1beta1_raft_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_raft_v1beta1_raft_proto_msgTypes[3].Exporter = func(v any, i int) any {
