...
var file_quarterdeck_query_v1beta1_query_proto_goTypes = []any{
...
func file_quarterdeck_query_v1beta1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_quarterdeck_query_v1beta1_query_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_quarterdeck_query_v1beta1_query_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_quarterdeck_query_v1beta1_query_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_quarterdeck_query_v1beta1_query_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Result); i {
			case 0:
				return &v.state
			case 1:
		...
		file_quarterdeck_query_v1beta1_query_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_quarterdeck_query_v1beta1_query_proto_msgTypes[2].OneofWrappers = []any{
		(*Parameter_I)(nil),
		(*Parameter_D)(nil),
		(*Parameter_B)(nil),
		(*Parameter_Y)(nil),
